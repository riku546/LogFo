        ...
        {generatedRoadmap ? (
          ...
          <form onSubmit={handleGenerate} className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      setDailyStudyHours(Number(event.target.value))
                    }
            ...
            <button
              ...
              className="w-full cursor-pointer rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 px-6 py-4 text-lg font-bold text-white shadow-lg transition-all hover:from-blue-600 hover:to-indigo-600 hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-50"
            >
              {isGenerating ? (
