...
export const ConfigSidebar = ({
  ...
  return (
    <aside className="relative flex h-full min-h-0 w-full shrink-0 flex-col border-r border-white/10 bg-white/55 p-4 backdrop-blur-xl dark:border-white/5 dark:bg-slate-800/55 lg:w-[26rem] lg:p-6">
      ...
      <section className="glass mt-4 rounded-xl border border-slate-300/70 bg-slate-100/70 p-4 dark:border-white/15 dark:bg-transparent">
        <div className="mb-3 flex items-center gap-2">
          <MessageSquare className="h-4 w-4 text-blue-500" />
          <h3 className="font-(--font-poppins) text-sm font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
            メッセージ入力
          </h3>
        </div>
        ...
        <select
          ...
          className="mb-3 w-full cursor-pointer rounded-xl border border-slate-300 bg-white px-3 py-2 text-slate-900 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50 dark:border-white/15 dark:bg-slate-700/80 dark:text-slate-100"
        >
        ...
        <textarea
          ...
          className="w-full resize-y rounded-xl border border-slate-300 bg-white px-3 py-2 text-slate-900 placeholder:text-slate-500 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50 dark:border-white/15 dark:bg-slate-700/80 dark:text-slate-100 dark:placeholder:text-slate-400"
        />

        <button
          type="button"
          onClick={onOpenSummarySelection}
          className="mt-3 inline-flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 transition-all duration-300 hover:bg-slate-50 dark:border-white/15 dark:bg-slate-700/70 dark:text-slate-200 dark:hover:bg-slate-700"
        >
          生成に使うサマリーを選択
        </button>
        ...
        <button
          ...
          disabled={!canSend}
          className="mt-3 inline-flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-blue-600 px-3 py-2 text-sm font-medium text-white transition-all duration-300 hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
        >
