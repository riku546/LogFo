...
export interface ExternalActivityRepository {
   ...
   */
  upsertActivities(activities: Omit<ExternalActivity, "id" | "createdAt" | "updatedAt">[]): Promise<void>;
   ...
   */
  getActivitiesByDateRange(userId: string, startDate: string, endDate: string): Promise<ExternalActivity[]>;
